model wrapped "Wrapped model"
	// Input overwrite
	Modelica.Blocks.Interfaces.RealInput regul_Chaudiere_Securite_oveHea_u(unit="1", min=0.0, max=1.0) "Zone temperature setpoint for heating";
	Modelica.Blocks.Interfaces.BooleanInput regul_Chaudiere_Securite_oveHea_activate "Activation for Zone temperature setpoint for heating";
	...
	Modelica.Blocks.Interfaces.RealInput conHeaRoom3_oveHea_u(unit="1", min=0.0, max=1.0) "Zone temperature setpoint for heating";
	Modelica.Blocks.Interfaces.BooleanInput conHeaRoom3_oveHea_activate "Activation for Zone temperature setpoint for heating";
	...
	Modelica.Blocks.Interfaces.RealInput con_pumHea_oveHea_u(unit="1", min=0.0, max=1.0) "Zone temperature setpoint for heating";
	Modelica.Blocks.Interfaces.BooleanInput con_pumHea_oveHea_activate "Activation for Zone temperature setpoint for heating";
	...
	Modelica.Blocks.Interfaces.RealInput conHeaBathroom_oveHea_u(unit="1", min=0.0, max=1.0) "Zone temperature setpoint for heating";
	Modelica.Blocks.Interfaces.BooleanInput conHeaBathroom_oveHea_activate "Activation for Zone temperature setpoint for heating";
	...
	Modelica.Blocks.Interfaces.RealInput conHeaRoom1_oveHea_u(unit="1", min=0.0, max=1.0) "Zone temperature setpoint for heating";
	Modelica.Blocks.Interfaces.BooleanInput conHeaRoom1_oveHea_activate "Activation for Zone temperature setpoint for heating";
	Modelica.Blocks.Interfaces.RealInput conHeaRoom2_oveHea_u(unit="1", min=0.0, max=1.0) "Zone temperature setpoint for heating";
	Modelica.Blocks.Interfaces.BooleanInput conHeaRoom2_oveHea_activate "Activation for Zone temperature setpoint for heating";
	Modelica.Blocks.Interfaces.RealInput conHeaBoiler_oveHea_u(unit="1", min=0.0, max=1.0) "Zone temperature setpoint for heating";
	Modelica.Blocks.Interfaces.BooleanInput conHeaBoiler_oveHea_activate "Activation for Zone temperature setpoint for heating";
	Modelica.Blocks.Interfaces.RealInput conHeaLivingRoom_oveHea_u(unit="1", min=0.0, max=1.0) "Zone temperature setpoint for heating";
	Modelica.Blocks.Interfaces.BooleanInput conHeaLivingRoom_oveHea_activate "Activation for Zone temperature setpoint for heating";
	...
	DetachedHouse_ENGIE_IBPSAP1.DetachedHouse_ENGIE_IBPSAP1_BOPTEST_v3 mod(
		regul_Chaudiere_Securite.oveHea(uExt(y=regul_Chaudiere_Securite_oveHea_u),activate(y=regul_Chaudiere_Securite_oveHea_activate)),
		...
		conHeaRoom3.oveHea(uExt(y=conHeaRoom3_oveHea_u),activate(y=conHeaRoom3_oveHea_activate)),
		...
		con_pumHea.oveHea(uExt(y=con_pumHea_oveHea_u),activate(y=con_pumHea_oveHea_activate)),
		regul_Chambre2.ovePCoo(uExt(y=regul_Chambre2_ovePCoo_u),activate(y=regul_Chambre2_ovePCoo_activate)),
		conHeaBathroom.oveHea(uExt(y=conHeaBathroom_oveHea_u),activate(y=conHeaBathroom_oveHea_activate)),
		...
		conHeaRoom1.oveHea(uExt(y=conHeaRoom1_oveHea_u),activate(y=conHeaRoom1_oveHea_activate)),
		conHeaRoom2.oveHea(uExt(y=conHeaRoom2_oveHea_u),activate(y=conHeaRoom2_oveHea_activate)),
		conHeaBoiler.oveHea(uExt(y=conHeaBoiler_oveHea_u),activate(y=conHeaBoiler_oveHea_activate)),
		conHeaLivingRoom.oveHea(uExt(y=conHeaLivingRoom_oveHea_u),activate(y=conHeaLivingRoom_oveHea_activate)),
		...
		conHeaBathroom.oveTsetHea(uExt(y=conHeaBathroom_oveTsetHea_u),activate(y=conHeaBathroom_oveTsetHea_activate))) "Original model with overwrites";
end wrapped;