...
model Regul_Ch_1_bis
  ...
  IBPSA.Utilities.IO.SignalExchange.Read reaTzone(
    KPIs=IBPSA.Utilities.IO.SignalExchange.SignalTypes.SignalsForKPIs.AirZoneTemperature,

    y(unit="K"),
    description="Zone temperature")
    annotation (Placement(transformation(extent={{-88,0},{-82,6}})));
equation
  ...
  connect(T, reaTzone.u) annotation (Line(points={{-108,12},{-98,12},{-98,3},{
          -88.6,3}}, color={0,0,127}));
  annotation (
